...
const withDrawer = (Component)=> {
  ...
  const EnhanceComponent = (props)=> {
      ...
      const [open, setOpen] = React.useState( storedOpen ?? false);
      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <AppBar position="fixed" open={open}>
          <Toolbar >
            ...
            <Box>
                <IconButton component={Link} to="/cart" sx={{color: '#fff'}} aria-label="cart">
        ...
        >
          ...
          <Divider />
          <List>
            <ListItem component={Link} to="/login" key='logout' onClick={logout} >
              <ListItemIcon>
                <LogoutIcon />
              </ListItemIcon>
